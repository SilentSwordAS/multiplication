...
def user_input_features():
    ...
    num_1 = st.number_input("Enter Number 1",min_value=float('0'),max_value=float('99999'))
    num_2 = st.number_input("Enter Number 2",min_value=float('0'),max_value=float('99999'))
